...
function Form({users, setUsers}) {
    ...
    const [country, setCountry] = useState(""); // Valeur sélectionnée
    const [searchTerm, setSearchTerm] = useState(""); // Valeur de recherche
    ...
    const fetchCountries = async (searchTerm) => {
        ...
        try {
            ...
            // Maintenir le focus après la mise à jour des résultats
            setTimeout(() => {
                if (inputRef.current) {
